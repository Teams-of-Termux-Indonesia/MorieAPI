...
class RAP_Facebook
{
    ...
    public static function download($url)
    {
        ...
        try {
            ...
            if ($hdLink = RAP_Facebook::getHDLink($data)) {
                $msg['links']['video_hd'] = $hdLink;
            }
        } catch (Exception $e) {
            $msg['success'] = false;
    ...
    public static function getSDLink($curl_content)
    {
        ...
        if (preg_match($regexRateLimit, $curl_content, $match)) {
            return RAP_Facebook::cleanStr($match[1]);
        } else {
            return false;
        }
    }
